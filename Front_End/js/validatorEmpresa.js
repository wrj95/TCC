$(document).ready(function(){
    ...
    $.getJSON('http://buscafrete.net:3050/lista/estados', function (data) {
        ...
        $("#estados").change(function () {	//Quando uma cidade for escolhida	
            ...
            $.getJSON('http://buscafrete.net:3050/lista/cidades/' + str, function (data){
        ...
        $('#myform').validate({ //Validação dos campos do formulário
            ...
            submitHandler: function(form){
                ...
                $.ajax({
                    ...
                    url: 'http://buscafrete.net:3050/company/register', //URL da API
